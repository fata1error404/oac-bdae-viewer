...
//[-NAV_MESH_MAX_TILE_INDEX, NAV_MESH_MAX_TILE_INDEX)
dtMeshTile* dtNavMesh::getTileAt(int x, int y) const
{
	// Find tile based on hash.
	if ((x >= -NAV_MESH_MAX_TILE_INDEX && x < NAV_MESH_MAX_TILE_INDEX) 
		&& (y >= -NAV_MESH_MAX_TILE_INDEX && y < NAV_MESH_MAX_TILE_INDEX))
	{
