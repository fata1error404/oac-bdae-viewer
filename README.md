...
$$
v^{\ \prime} = (\sum_{i=0}^{N} w_i \cdot (L_{node_i} \cdot B_i)) \cdot v, \quad  \sum_{i=0}^{N} w_i = 1
$$
...
$B_i$ – inverse bind pose 4 x 4 matrix of the $i$-th bone
